export default {
  ...
  v2: {
    ...
    gallery: {
      ...
      edition: 'No. 01, Summer',
      title: 'The island,<br>in <em>pictures</em>',
      intro: 'A photographic record of a stone house in the Alaybey quarter — its five rooms, and the island of vineyards and windmills around it. Thirteen plates, three chapters.',
      introMobile: 'Three chapters — swipe through each. Tap any plate to view it full frame.',
      plate: 'Plate',
      plateShort: 'Pl.',
      swipe: 'Swipe',
      chapters: {
        house: 'The House',
        houseSub: 'Ev · Alaybey Quarter',
        rooms: 'The Rooms',
        roomsSub: 'Odalar · Five myths',
        island: 'The Island',
        islandSub: 'Ada · Tenedos',
      },
      captions: {
        house1: 'Stone, wood and bougainvillea',
        house2: 'Morning in the courtyard',
        house3: 'Where the light comes to rest',
        house4: 'Restored in 2024, faithful to the wind',
        island1: 'Vineyards, windmills, salt air',
        island2: 'The old streets of Alaybey',
        island3: 'Golden hour, poured slowly',
        island4: 'The Aegean, always near',
      },
      quoteHouse: '“The stone structures of the island were shaped over centuries by wind, sea and climate. Yaz Evi carries that patience into the present.”',
      quoteHouseBy: 'From our story · Hikayemizden',
      quoteIsland: '“We came for one night and stayed for four. The light, the stone, the silence.”',
      quoteIslandBy: 'Elif & Deniz · İstanbul',
      ctaTitle: 'Come see the<br>rest <em>yourself</em>',
      ctaBody: 'Five rooms, one terrace, and the slowest sunsets in the Aegean. The camera only gets you so far.',
    },
    booking: {
