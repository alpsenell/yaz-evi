export default {
  ...
  booking: {
    heroLede: "Pick a room and dates. Our season runs May through October. We hold every reservation until you receive a confirmation email — usually within minutes.",
  ...
  footer: {
    ...
    tagline: "A five-room stone house in Alaybey, Bozcaada. Open May through October.",
    pages: 'Pages',
    contact: 'Contact',
    season: 'Season',
  },
  roomsIndex: {
    eyebrow: 'Rooms',
    titleLine1: 'Five rooms.',
    titleLine2: 'Five names',
    titleLine3: 'from myth.',
    lede: 'Each room carries the story of its own name. Five different quiets under the same roof.',
    detailLink: 'View room',
    capacity: 'guests',
    area: 'm²',
    view: 'View',
    from: 'From',
  ...
  aboutPage: {
    eyebrow: 'Story',
    titleLine1: 'A stone house',
    titleLine2: 'and the people',
    titleLine3: 'who remade it',
    lede: "Yaz Evi is less a restoration and more an act of slowing down. We tried to preserve Bozcaada's 130-year-old walls and fit inside them a life made only for resting.",
    quoteLabel: 'From the family',
    quote: 'Restoration is not preserving the old. It is giving the old new meaning.',
    quoteAttr: '— The family, 2024',
    heroImageAlt: 'Yaz Evi exterior — restored stone facade',
    imgCourtyardAlt: 'Yaz Evi inner courtyard',
    imgDetailAlt: 'Architectural detail of the restoration',
  },
  experiencesPage: {
    eyebrow: 'Experience',
    titleLine1: 'Things',
    titleLine2: 'to do',
    titleLine3: 'on the island',
    lede: 'Yaz Evi is a reminder of the island just outside its door. All the experiences below are within a 15-minute walk — or a bike-ride away.',
    seasonLabel: 'Season',
    seasonNote: 'May – October',
  },
  galleryPage: {
    eyebrow: 'Gallery',
    titleLine1: 'A summer archive',
    titleLine2: 'from one island',
    lede: 'A selection from the rooms, the courtyard, and the windmill hills of Bozcaada. All from the same season, the same light.',
  ...
  contactPage: {
    ...
    titleLine1: 'Write',
    titleLine2: 'to us',
    lede: 'For reservations, special requests, or small questions. We usually reply within 24 hours.',
    formTitle: 'Message',
    name: 'Name',
    email: 'Email',
    subject: 'Subject',
  ...
  home: {
    hero: {
      eyebrow: 'Bozcaada · Alaybey District',
      titleLine1: 'A long summer',
      titleLine2: 'between',
      titleLine3: 'old stone walls',
      lede: "Five rooms. One courtyard. A restoration shaped by the island wind. Yaz Evi borrows its names from myth — and tells a different story to every guest.",
      exploreRooms: 'Explore Rooms',
      heroImageAlt: 'Yaz Evi Bozcaada — historic stone facade in Alaybey',
    },
    meta: {
      rooms: '5 rooms',
      season: 'Open · May – October 2026',
    },
    house: {
      label: 'The House',
      title: "A stone house\nbreathing again",
      body: "Walls laid in the 1890s, restored in natural lime plaster. Wooden beams kept faithful to the original. Every detail designed in favor of quiet — because on Bozcaada, the most beautiful sound is the wind speaking through vine leaves.",
      imgCourtyardAlt: 'Yaz Evi inner courtyard with vines and stone walls',
      imgInteriorAlt: 'Restored wooden interior beams and natural light',
      imgDetailAlt: 'Architectural detail of restored stone and lime plaster',
    },
    pullQuote: 'The silence here is not a luxury. It is an inheritance.',
    rooms: {
      note: 'Five names from myth',
      zeusNote: 'Courtyard view',
      heraNote: 'Calm and bright',
      tenedosNote: 'Historic traces',
      tenesNote: 'Island detailing',
      ilyadaNote: 'Mythic, quiet',
    },
    experience: {
      label: 'Experience',
      title: "An island,\nnine lives.",
      body: "Wine tasting, windmills, sunset beaches. Yaz Evi is the starting point for everything you'll discover on the island.",
      cta: 'See experiences',
      imageAlt: 'Bozcaada windmills overlooking the Aegean',
    },
  },
  confirmation: {
