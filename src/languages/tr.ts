export default {
  ...
  room4: "Oda Tenes",
  room5: "Oda Ilyada",
  room1Description: "Antik Yunan tanrısı, gücün ve asaletin simgesi Zeus; Bozcaada'nın mitolojik hikayelerinde ve antik para biriminde yer alır. Bu oda, doğal taşlar ve zarif ahşap detaylarla tasarlanmıştır — taş duvarlar Zeus'un gücünü simgeler, ahşap detaylar sıcaklık ve huzur yaratır.",
  room2Description: "Hera; büyülü doğayı, huzuru ve dengeyi simgeleyen, zamanında adada yerleşim bulduğu anlatılan bir tanrıçadır. Hera odası, Bozcaada'nın dingin ve güvenli atmosferine mükemmel uyum sağlar; adanın mitolojik ruhunu yaşatır.",
  room3Description: "Bozcaada'nın antik dönemdeki adlarından biri Tenedos'tur — mitolojik savaşların ve destanların adası. Tenedos Odası, tarihi kimliğin izlerini yaşatır; taş ve ahşabın doğal uyumu, geçmiş ile günümüz arasındaki bağı somutlaştırır.",
  room4Description: "Tenes, adanın ilk yerleşimcisi olarak kabul edilen bir efsanenin kahramanıdır. Tenes Odası; bu yerleşimin ruhunu taşıyan taş duvarlar, zarif ahşap detaylar ve geleneksel adalı dokunuşlarla dekore edilmiştir.",
  room5Description: "İlyada Destanı, Bozcaada'nın tarihi izlerine ilk rastlanan destandır. İlyada Odası'nın her bir detayında, ahşap ve taşın uyumuyla tarihsel derinlik ve zarif dokunuşlar bir araya gelir.",
  ...
  v2: {
    ...
    hero: {
      eyebrow: 'Butik Otel · Bozcaada · Tenedos',
      title: 'Yazın taşta saklandığı ev',
      sub: 'Summer, kept in stone',
    },
    home: {
      islandEyebrow: 'Ada — The Island',
      islandTitle: 'Kendinizi<br>ışığa bırakın',
      islandBody: 'Bir zamanlar Tenedos denilen bu küçük Kuzey Ege adası; bağlarını, yel değirmenlerini ve taş evlerini yüzyıllar boyunca korudu. Yaz Evi, tarihi Alaybey Mahallesi\'nde yer alıyor — 2024\'te restore edildi; onu şekillendiren rüzgâra, denize ve ışığa sadık kaldı.',
      roomsEyebrow: 'Odalar · The Rooms',
      roomsTitle: 'Beş oda, beş mit',
      expEyebrow: 'Düşler koyu · Deneyimler',
      expTitle: 'Zaman, adanın tuttuğu gibi',
      exp1Eyebrow: 'Şarap & Gün Batımı · Wine & Sunset',
      exp1Title: 'Altın saat, yavaşça dolan kadehler',
      exp1Body: 'Bir kadeh ada şarabı ve yerel peynir tabağıyla güneşin denize süzülüşünü izleyin. Gökyüzü kızıla, mora ve pembeye dönerken gerisini bağ meltemi halleder.',
      exp2Eyebrow: 'Taş Ev · The Stone House',
      exp2Title: 'Hatırlayan bir ev',
      exp2Body: 'Rüzgârın ve tuzun yüzyıllar boyunca şekillendirdiği yerel taş ve doğal ahşap. Adanın sükûnetini bugüne taşıyan beş oda.',
      exp3Eyebrow: 'Ada Yaşamı · Island Life',
      exp3Title: 'Her şey, kısa bir yürüyüş mesafesinde',
      exp3Body: 'Küçük kafeler, balık lokantaları, sanat galerileri ve butikler eski taş evlerin arasına kurulmuş. Kapıdan çıkın; ada çoktan sizin.',
      diningEyebrow: 'Mutfak · Gastronomy',
      diningTitle: 'Asma terasında kahvaltı',
      diningBody: 'Ada domatesi, tuzlu peynir, sıcak ekmek ve tepelerden gelen bal — asmaların altına kurulmuş ağır aksak bir Ege sabahı.',
      quote: 'Bir gece için geldik, dört gece kaldık. Işık, taş, sessizlik — Yaz Evi bir otelden çok adanın kendi evi gibi.',
      quoteAuthor: 'Elif & Deniz · İstanbul',
      momentsTitle: 'Adadan kareler',
      inkEyebrow: 'Yaz Evi · Bozcaada',
      inkTitle: "Bozcaada'nın en<br>özel evi",
      inkSub: "Bozcaada's most exclusive home",
    },
    roomsPage: {
      eyebrow: 'Konaklama · Accommodation',
      title: 'Odalar',
    },
    roomPage: {
      eyebrow: 'Konaklama · Oda',
      about: 'Oda hakkında',
    ...
    roomTags: {
      zeus: 'Güç; taşta ve ahşapta',
      hera: 'Huzur, doğa ve denge',
      tenedos: 'Geçmişle bugün arasında',
      tenes: 'Adanın ilk yerleşimcisi',
      ilyada: 'Tarihsel derinlik, destan ruhu',
    },
    roomShortDesc: {
      zeus: 'Gücün ve asaletin tanrısına adanmış — sağlamlık için doğal taş, sıcaklık ve dinginlik için ahşap.',
      hera: 'Huzurun ve dengenin tanrıçasına — adanın dingin, güvenli ruhuyla uyum içinde.',
    ...
    experiences: {
      ...
      title: 'Şarap & Gün Batımı',
      sub: 'Wine & Sunset',
      intro: 'Yemyeşil doğa ve bağlarla çevrili, Bozcaada\'nın en nefes kesici gün batımı manzaralarından biri.',
      s1Title: 'Güneş batarken yerel şaraplar',
      s1Body: 'Bozcaada doğasının kalbinde en etkileyici gün batımına tanıklık edin. Altın güneş denize süzülürken, her biri adanın kendine özgü teruarını yansıtan özenle seçilmiş yerel şarapların tadını çıkarın.',
      s2Title: 'Peynir tabakları, ada lezzetleri',
      s2Body: 'Özenle hazırlanan tabaklar — yerel peynirler, kuru meyveler ve taze mezeler — şarabın aromalarını güçlendirerek unutulmaz bir tat deneyimi sunar.',
      ctaTitle: 'Gün batımınızı ayırtın',
    },
    about: {
      eyebrow: 'Hikayemiz · Our Story',
      title: 'Hakkımızda',
      heading: 'Restore edilmiş tarihi bir taş evde huzur',
      headingSub: 'Peace in a restored historic building',
    },
    gallery: {
      eyebrow: 'Galeri · Gallery',
      edition: 'No. 01, Yaz',
      title: 'Ada,<br><em>karelerde</em>',
      intro: 'Alaybey mahallesindeki bir taş evin fotoğraflı kaydı — beş odası ve çevresini saran bağlarıyla, yel değirmenleriyle ada. On üç levha, üç bölüm.',
      introMobile: 'Üç bölüm — her birini kaydırarak gezin. Tam kare görmek için bir levhaya dokunun.',
      plate: 'Levha',
      plateShort: 'Lv.',
      swipe: 'Kaydırın',
      chapters: {
        house: 'Ev',
        houseSub: 'The House · Alaybey',
        rooms: 'Odalar',
        roomsSub: 'The Rooms · Beş mit',
        island: 'Ada',
        islandSub: 'The Island · Tenedos',
      },
      captions: {
        house1: 'Taş, ahşap ve begonvil',
        house2: 'Avluda sabah',
        house3: 'Işığın dinlenmeye geldiği yer',
        house4: '2024\'te, rüzgâra sadık kalınarak restore edildi',
        island1: 'Bağlar, yel değirmenleri, tuzlu hava',
        island2: 'Alaybey\'in eski sokakları',
        island3: 'Ağır ağır dolan altın saat',
        island4: 'Ege, hep yakında',
      },
      quoteHouse: '“Adanın taş yapıları rüzgârla, denizle ve iklimle yüzyıllar içinde şekillendi. Yaz Evi o sabrı bugüne taşıyor.”',
      quoteHouseBy: 'Hikayemizden · From our story',
      quoteIsland: '“Bir gece için geldik, dört gece kaldık. Işık, taş, sessizlik.”',
      quoteIslandBy: 'Elif & Deniz · İstanbul',
      ctaTitle: 'Gerisini gelin<br><em>kendiniz</em> görün',
      ctaBody: 'Beş oda, bir teras ve Ege\'nin en yavaş gün batımları. Kamera sizi ancak bir yere kadar götürür.',
    },
    booking: {
      eyebrow: 'Rezervasyon · Reservation',
      yourRoom: 'Odanız · Your room',
      selectDates: 'Tarihlerinizi seçin',
      bookedNote: 'Dolu geceler otomatik olarak kapatılır.',
      yourSelection: 'Seçiminiz',
      booked: 'Dolu',
      summaryEyebrow: 'Özet · Your selection',
      total: 'Toplam',
    ...
    contact: {
      ...
      body: 'Sizden haber almayı çok isteriz. Formu doldurun veya doğrudan e-posta gönderin — en kısa sürede dönüş yaparız.',
      phone: 'Telefon',
      email: 'E-posta',
      address: 'Adres',
      sent: 'Mesajınız gönderildi — teşekkürler!',
    },
    policy: {
      eyebrow: 'Yasal · Legal',
      acceptance: 'Kabul',
    ...
    footer: {
      tagline: 'Ege\'ye karşı bir taş ev, Bozcaada\'da.',
      findUs: 'Bizi Bulun',
      contact: 'İletişim',
      follow: 'Takip Edin',
    },
