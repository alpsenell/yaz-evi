...
<template>
  <footer class="max-w-screen-2xl px-10 py-6">
    <div class="flex justify-between flex-col gap-4">
      <div class="flex gap-4">
        <svg class="w-[16px] h-[16px]" fill="#000000" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
    ...
    <ul class="flex flex-row ga-6 font-raleway text-sm gap-8 mt-6">
      <li>
        &copy; 2024 Yaz Evi
      </li>
      <li>
